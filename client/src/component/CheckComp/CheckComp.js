...
export default function CheckComp() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.get(`http://localhost:3001/api/check-status/:id`)
  ...
  return (
    <div className="container mt-5 bg-light rounded-4 shadow" style={{ maxWidth: "500px" }}>
    <Form className="text-center" onSubmit={handleSubmit}>
      ...
      <div className="row justify-content-center text-center gap-5 mt-3">
        <Button className="btn btn-success col-4
         text-center  rounded-4 " type="submit">Check</Button>
        <a href="/" className="btn btn-success col-4 
